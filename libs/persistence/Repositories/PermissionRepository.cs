...
public class PermissionRepository : RepositoryBase
{
    ...
    public async Task<Central.Engine.Auth.AuthUser?> GetUserByUsernameAsync(string username)
    {
        try
        {
            await using var conn = CreateConnection();
            ...
            {
                return new Central.Engine.Auth.AuthUser
                {
    ...
    public async Task<Central.Engine.Auth.AuthUser?> GetUserByIdAsync(int userId)
    {
        try
        {
            await using var conn = CreateConnection();
    ...
    public async Task<Central.Engine.Auth.AuthUser?> GetUserByEmailAsync(string email)
    {
        try
        {
            await using var conn = CreateConnection();
