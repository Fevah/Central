...
public partial class DbRepository
{
    ...
    public async Task<List<Central.Engine.Models.GanttPredecessorLink>> GetGanttLinksAsync(int? projectId = null)
    {
        var list = new List<Central.Engine.Models.GanttPredecessorLink>();
        await using var conn = await OpenConnectionAsync();
        ...
        while (await rdr.ReadAsync())
        {
            ...
            list.Add(new Central.Engine.Models.GanttPredecessorLink
            {
    ...
    public async Task<List<Central.Engine.Models.TaskItem>> GetBugsAsync(int? projectId = null)
    {
    ...
    public async Task<List<Central.Engine.Models.Dashboard>> GetDashboardsAsync()
    {
        var list = new List<Central.Engine.Models.Dashboard>();
        await using var conn = await OpenConnectionAsync();
        await using var cmd = new NpgsqlCommand(@"
        ...
        await using var rdr = await cmd.ExecuteReaderAsync();
        while (await rdr.ReadAsync())
            list.Add(new Central.Engine.Models.Dashboard
            {
    ...
    public async Task UpsertDashboardAsync(Central.Engine.Models.Dashboard d)
    {
        await using var conn = await OpenConnectionAsync();
        if (d.Id == 0)
        {
