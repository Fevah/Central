...
public partial class DbRepository
{
    ...
    public Task<List<Central.Engine.Models.SavedFilter>> GetSavedFiltersAsync(int userId, string panelName)
    ...
    {
        await UpsertSavedFilterAsync(new Central.Engine.Models.SavedFilter
        {
