...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class Currency : TIG.TotalLink.Shared.DataModel.Admin.StampedDataObjectBase
    {
        string _Code;
        [Size(10)]
        public string Code
        ...
        [Association(@"ContactReferencesCurrencies", typeof(Contact))]
        public XPCollection<Contact> Contacts { get { return GetCollection<Contact>("Contacts"); } }
        [Association(@"ExchangeRateReferencesCurrency", typeof(ExchangeRate))]
