...
using TIG.IntegrationServer.Plugin.Agent.ECommerceAgent.Entity;
...
namespace TIG.IntegrationServer.Plugin.Agent.ECommerceAgent.Agent
{
    public class EcommerceAgent : AgentBase
    {
        ...
        public EcommerceAgent(IServiceContext context)
        {
            _context = context;
        }
