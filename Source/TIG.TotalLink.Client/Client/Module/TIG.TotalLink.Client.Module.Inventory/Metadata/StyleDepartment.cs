...
namespace TIG.TotalLink.Shared.DataModel.Inventory
{
    ...
    public partial class StyleDepartment
    {
        ...
        public static void BuildMetadata(MetadataBuilder<StyleDepartment> builder)
        {
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<StyleDepartment> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
