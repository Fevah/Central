...
namespace TIG.TotalLink.Shared.DataModel.Inventory
{
    ...
    public partial class StyleCategory
    {
        ...
        public static void BuildMetadata(MetadataBuilder<StyleCategory> builder)
        {
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<StyleCategory> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
