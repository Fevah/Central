...
namespace TIG.TotalLink.Shared.DataModel.Inventory
{
    ...
    public partial class BusinessDivision
    {
        ...
        public static void BuildMetadata(MetadataBuilder<BusinessDivision> builder)
        {
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<BusinessDivision> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
