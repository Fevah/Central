...
namespace TIG.TotalLink.Shared.DataModel.Inventory
{
    ...
    public partial class BarcodeType
    {
        ...
        public static void BuildMetadata(MetadataBuilder<BarcodeType> builder)
        {
            ...
            builder.Property(p => p.Barcodes).NotAutoGenerated();
        }
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<BarcodeType> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
