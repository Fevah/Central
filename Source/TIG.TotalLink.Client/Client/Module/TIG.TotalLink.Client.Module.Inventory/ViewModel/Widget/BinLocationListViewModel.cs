...
{
    public class BinLocationListViewModel : ListViewModelBase<BinLocation>
    {
        ...
        public BinLocationListViewModel()
        {
        }

        public BinLocationListViewModel(IInventoryFacade inventoryFacade)
        {
            // Store services.
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _inventoryFacade.CreateInstantFeedbackSource<BinLocation>();
            });
        }
