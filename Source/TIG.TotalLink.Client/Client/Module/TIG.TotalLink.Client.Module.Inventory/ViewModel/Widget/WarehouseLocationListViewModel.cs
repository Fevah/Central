...
{
    public class WarehouseLocationListViewModel : ListViewModelBase<WarehouseLocation>
    {
        ...
        public WarehouseLocationListViewModel()
        {
        }

        public WarehouseLocationListViewModel(IInventoryFacade inventoryFacade)
        {
            // Store services.
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _inventoryFacade.CreateInstantFeedbackSource<WarehouseLocation>();
            });
        }
