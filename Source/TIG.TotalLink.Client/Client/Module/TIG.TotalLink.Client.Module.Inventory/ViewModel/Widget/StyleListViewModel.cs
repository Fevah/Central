...
{
    public class StyleListViewModel : ListViewModelBase<Shared.DataModel.Inventory.Style>
    {
        ...
        public StyleListViewModel(IInventoryFacade inventoryFacade)
        {
            // Store services.
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _inventoryFacade.CreateInstantFeedbackSource<Shared.DataModel.Inventory.Style>();
            });
        }
