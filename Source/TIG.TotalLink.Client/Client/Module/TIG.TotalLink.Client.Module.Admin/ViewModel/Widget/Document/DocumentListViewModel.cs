...
{
    public class DocumentListViewModel : ListViewModelBase<Shared.DataModel.Admin.Document>
    {
        ...
        public DocumentListViewModel(IAdminFacade adminFacade)
            : this()
        {
            // Store services
        ...
        protected virtual void OnOpenExecute()
        {
            ...
            {
                ShowDocumentMessage.Send(this, document, null);
            }
        }
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _adminFacade.CreateInstantFeedbackSource<Shared.DataModel.Admin.Document>();
            });
        }
