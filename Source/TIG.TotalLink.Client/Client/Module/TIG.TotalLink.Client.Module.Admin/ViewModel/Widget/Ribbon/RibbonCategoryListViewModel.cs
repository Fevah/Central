...
{
    public class RibbonCategoryListViewModel : ListViewModelBase<RibbonCategory>
    {
        ...
        public RibbonCategoryListViewModel()
        {
        }

        public RibbonCategoryListViewModel(IAdminFacade adminFacade)
            : this()
        {
            // Store services
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _adminFacade.CreateInstantFeedbackSource<RibbonCategory>();
            });
        }
