...
{
    public class RibbonPageListViewModel : ListViewModelBase<RibbonPage>
    {
        ...
        public RibbonPageListViewModel()
        {
        }

        public RibbonPageListViewModel(IAdminFacade adminFacade)
            : this()
        {
            // Store services
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _adminFacade.CreateInstantFeedbackSource<RibbonPage>();
            });
        }
