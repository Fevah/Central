...
{
    public class StateListViewModel : ListViewModelBase<State>
    {
        ...
        public StateListViewModel(IAdminFacade adminFacade)
            : this()
        {
            // Store services.
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _adminFacade.CreateInstantFeedbackSource<State>();
            });
        }
