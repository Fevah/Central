...
{
    public class SyncEntityListViewModel : ListViewModelBase<SyncEntity>
    {
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _integrationFacade.CreateInstantFeedbackSource<SyncEntity>();
            });
        }
