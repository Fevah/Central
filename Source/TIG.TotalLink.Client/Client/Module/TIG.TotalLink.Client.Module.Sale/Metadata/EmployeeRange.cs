...
namespace TIG.TotalLink.Shared.DataModel.Sale
{
    ...
    public partial class EmployeeRange
    {
        ...
        public static void BuildMetadata(MetadataBuilder<EmployeeRange> builder)
        {
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<EmployeeRange> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
