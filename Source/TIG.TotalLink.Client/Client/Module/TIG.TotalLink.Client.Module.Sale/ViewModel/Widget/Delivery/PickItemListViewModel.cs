...
{
    public sealed class PickItemListViewModel : ListViewModelBase<PickItem>
    {
        ...
        public PickItemListViewModel(ISaleFacade saleFacade)
        {
            // Store services.
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _saleFacade.CreateInstantFeedbackSource<PickItem>();
            });
        }
