...
{
    public class InvoiceListViewModel : ListViewModelBase<Shared.DataModel.Sale.Invoice>
    {
        ...
        public InvoiceListViewModel(ISaleFacade saleFacade)
        {
            // Store services.
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _saleFacade.CreateInstantFeedbackSource<Shared.DataModel.Sale.Invoice>();
            });
        }
