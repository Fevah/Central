...
{
    public sealed class SalesOrderReleaseListViewModel : ListViewModelBase<Shared.DataModel.Sale.SalesOrderRelease>
    {
        ...
        /// Default Constructor.
        /// </summary>
        public SalesOrderReleaseListViewModel()
        {
        }
        ...
        public SalesOrderReleaseListViewModel(ISaleFacade saleFacade)
        {
            // Store services.
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _saleFacade.CreateInstantFeedbackSource<Shared.DataModel.Sale.SalesOrderRelease>();
            });
        }
