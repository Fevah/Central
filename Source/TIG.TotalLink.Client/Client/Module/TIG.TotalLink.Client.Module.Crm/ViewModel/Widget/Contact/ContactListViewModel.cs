...
{
    public class ContactListViewModel : ListViewModelBase<Shared.DataModel.Crm.Contact>
    {
        ...
        public ContactListViewModel(ICrmFacade crmFacade)
        {
            // Store services.
            _crmFacade = crmFacade;

            // Initialize commands
            AddPersonCommand = new AsyncCommandEx(OnAddPersonExecuteAsync, OnAddPersonCanExecute);
        ...
        /// <summary>
        /// Command to add a new Person to the list.
        /// </summary>
        [WidgetCommand("Add Person", "Edit", RibbonItemType.ButtonItem, "Add a new Person.")]
        ...
        /// <summary>
        /// Execute method for the AddPersonCommand.
        /// </summary>
        protected async Task OnAddPersonExecuteAsync()
        {
            await AddItemAsync<Person>();
        }

        /// <summary>
        /// CanExecute method for the AddPersonCommand.
        /// </summary>
        protected bool OnAddPersonCanExecute()
        {
        ...
        public override bool CanExecuteWidgetCommand
        {
            get
            {
                ...
                return !(
                    (AddPersonCommand != null && ((AsyncCommandEx)AddPersonCommand).IsExecuting)
        ...
        protected override void OnWidgetLoaded(EventArgs e)
        {
            ...
            AddStartupTask(() =>
            {
                ...
                ItemsSource = _crmFacade.CreateInstantFeedbackSource<Shared.DataModel.Crm.Contact>();
            });
        }
