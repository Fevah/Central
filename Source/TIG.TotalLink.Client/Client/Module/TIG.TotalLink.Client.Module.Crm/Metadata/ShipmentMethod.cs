...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class ShipmentMethod
    {
        ...
        public static void BuildMetadata(MetadataBuilder<ShipmentMethod> builder)
        {
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<ShipmentMethod> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
