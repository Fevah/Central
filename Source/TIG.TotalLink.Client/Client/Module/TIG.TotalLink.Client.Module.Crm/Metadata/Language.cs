...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class Language
    {
        ...
        public static void BuildMetadata(MetadataBuilder<Language> builder)
        {
            builder.TableLayout().Group("")
                .ContainsProperty(p => p.Code)
                .ContainsProperty(p => p.Name)
                .ContainsProperty(p => p.WindowsLanguageID)
                .ContainsProperty(p => p.WindowsLanguageName);
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<Language> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
