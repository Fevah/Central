...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class BusinessType
    {
        ...
        public static void BuildMetadata(MetadataBuilder<BusinessType> builder)
        {
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<BusinessType> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
