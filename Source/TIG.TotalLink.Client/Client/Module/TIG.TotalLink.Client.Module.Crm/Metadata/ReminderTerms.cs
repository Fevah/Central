...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class ReminderTerms
    {
        ...
        public static void BuildMetadata(MetadataBuilder<ReminderTerms> builder)
        {
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<ReminderTerms> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
