...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class PaymentMethod
    {
        ...
        public static void BuildMetadata(MetadataBuilder<PaymentMethod> builder)
        {
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<PaymentMethod> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
