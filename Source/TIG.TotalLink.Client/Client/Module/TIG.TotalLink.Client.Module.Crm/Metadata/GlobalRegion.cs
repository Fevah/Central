...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class GlobalRegion
    {
        ...
        public static void BuildMetadata(MetadataBuilder<GlobalRegion> builder)
        {
            ...
            builder.Property(p => p.Businesses).NotAutoGenerated();
        }
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<GlobalRegion> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
