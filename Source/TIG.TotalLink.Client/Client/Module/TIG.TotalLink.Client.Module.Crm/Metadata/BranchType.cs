...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class BranchType
    {
        ...
        public static void BuildMetadata(MetadataBuilder<BranchType> builder)
        {
            ...
            builder.Property(p => p.Branches).NotAutoGenerated();
        }
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<BranchType> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
