...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class ContactLinkType
    {
        ...
        public static void BuildMetadata(MetadataBuilder<ContactLinkType> builder)
        {
            ...
            builder.Property(p => p.ContactLinks).NotAutoGenerated();
        }
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<ContactLinkType> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
