...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class StaffRole
    {
        ...
        public static void BuildMetadata(MetadataBuilder<StaffRole> builder)
        {
            ...
            builder.Property(p => p.People).NotAutoGenerated();
        }
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<StaffRole> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
