...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class PaymentTerms
    {
        ...
        public static void BuildMetadata(MetadataBuilder<PaymentTerms> builder)
        {
            ...
            builder.Property(p => p.ContactsOfPaymentTerms).NotAutoGenerated();
            builder.Property(p => p.ContactsOfCashFlowPaymentTerms).NotAutoGenerated();
        }
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<PaymentTerms> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
