...
namespace TIG.TotalLink.Shared.DataModel.Crm
{
    ...
    public partial class ContactGroup
    {
        ...
        public static void BuildMetadata(MetadataBuilder<ContactGroup> builder)
        {
            ...
            builder.Property(p => p.ContactGroupLinks).NotAutoGenerated();
        }
        ...
        public static void BuildEditorMetadata(EditorMetadataBuilder<ContactGroup> builder)
        {
            builder.Sort()
                .ContainsProperty(p => p.Name);
        }
