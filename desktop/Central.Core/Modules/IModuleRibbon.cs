...
public interface IRibbonGroupBuilder
{
    ...
    void AddSeparator();
    void AddSplitButton(string content, string? permission, string? glyph, Action? primaryClick, Action<List<Central.Core.Shell.RibbonButtonRegistration>> configureSubItems);
}
